...
public class CommonGenerator extends DefaultCommentGenerator {
    ...
    public void addModelClassComment(TopLevelClass innerClass, IntrospectedTable introspectedTable) {
        ...
        innerClass.addJavaDocLine(" * @desc mbg自动生成" + introspectedTable.getFullyQualifiedTable().getIntrospectedTableName() + "表实体类");
        // model重新生成的日期时间
        innerClass.addJavaDocLine(" * @date " + new SimpleDateFormat("yyyy-MM-dd hh:mm").format(new Date()));
        innerClass.addJavaDocLine(" */");
    }

    ...
    <nav class="navbar navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <router-link to="/" class="navbar-brand">自习室签到预约系统</router-link>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><router-link v-if="user_store.userType === 'admin' " to="/all_students" >学生管理</router-link></li>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <template v-if="user_store.log_status == 1">
              ...
              <button class="btn btn-danger navbar-btn" @click="logout()">登出</button>
              </template>
          </ul>
